export default {
  ...
  template: `
    <div>
      ...
      <!-- Nota informativa -->
      <div class="card-solar mb-4" style="background:#FFF8E1">
        <p class="mb-0" style="font-size:.83rem">
          <i class="bi bi-info-circle-fill text-warning me-2"></i>
          Los documentos marcados con <strong>🔒 Privado</strong> contienen datos personales y no están disponibles para descarga pública. El resto se pueden abrir directamente con el botón verde.
        </p>
      </div>
          ...
          <div class="card-solar">
            ...
            <div v-for="doc in cat.docs" :key="doc.nombre"
              ...
              <div class="d-flex align-items-center gap-1 flex-shrink-0 ms-2">
                <span v-if="doc.privado"
                      class="badge-tag bg-secondary text-white"
                      title="Documento con datos personales — acceso restringido">
                  🔒 Privado
                </span>
                <a v-else
      ...
      categorias: [
        ...
        },
        {
          ...
          docs: [
            ...
            { icono: 'bi-file-earmark-pdf-fill', color: '#388E3C', nombre: 'Nota a vecinos (abril 2026)',   desc: 'Resumen del estado del proyecto y próximos pasos',            privado: true },
            { icono: 'bi-file-earmark-pdf-fill', color: '#388E3C', nombre: 'Recogida de firmas V2',        desc: 'Formulario de consentimiento para la instalación',            privado: true },
        ...
        },
        {
          ...
          docs: [
            ...
            { icono: 'bi-file-earmark-pdf-fill', color: '#7B1FA2', nombre: 'Correo a Equipo Impe (abr 2026)',             desc: 'Primera solicitud de asesoramiento técnico',                      privado: true },
            { icono: 'bi-file-earmark-pdf-fill', color: '#7B1FA2', nombre: 'Correo a Equipo Impe (may 2026)',             desc: 'Segunda comunicación antes del burofax',                          privado: true },
            { icono: 'bi-file-earmark-pdf-fill', color: '#7B1FA2', nombre: 'Correo presidente/admin (may 2026)',          desc: 'Solicitud de transparencia y contrato completo para la junta',    privado: true },
          ],
        },
        {
